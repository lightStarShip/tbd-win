...
namespace tbd
{
    internal static class Program
    {
        ...
        private static readonly Mutex mutex = new Mutex(true, $"TheBigDipper_{ExecutablePath.GetHashCode()}");
        ...
        private static void Main(string[] args)
        {
            ...
            if (hasAnotherInstance)
            {
                ...
                {
                    MessageBox.Show(I18N.GetString("Find TheBigDipper icon in your notify tray.")
                                    + Environment.NewLine
                                    + I18N.GetString("If you want to start multiple TheBigDipper, make a copy in another directory."),
                        I18N.GetString("TheBigDipper is already running."));
                }
                return;
            }
            #endregion
            ...
            if (!Utils.IsWinVistaOrHigher())
            {
                ...
                "TheBigDipper Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            if (!Utils.IsSupportedRuntimeVersion())
            {
                ...
                "TheBigDipper Error", MessageBoxButtons.OKCancel, MessageBoxIcon.Error))
                {
